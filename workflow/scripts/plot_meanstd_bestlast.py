...
def main(incsvfiles, outplot, filter_by_seed=42, legend=True, errorbars=True):
...
if __name__ == "__main__":
    if "snakemake" in globals() and (
        ...
        if hasattr(snakemake, "params") and hasattr(snakemake.params, "show_errorbars"):
            show_errorbars = snakemake.params.show_errorbars
